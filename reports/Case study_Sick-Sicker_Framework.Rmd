...
```{r}
table <- source("tables/03_summary-posterior.RData")
``` 


Interpreting these statistics can be quite hard and is easier via a graph. In section 03.4.2 we visualize the posterior distributions. These figures are save in the *figs* directory and shown below. 
