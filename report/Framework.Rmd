...
```{r STM_Sick_Sicker, out.width=75%, fig.cap="State-transition diagram of the Sick-Sicker model. Healthy individuals can get Sick, die or stay healthy. Sick individuals can recover, transitioning back to healthy, can die, or stay sick. Once individuals are Sicker, they stay Sicker until they die."}
#knitr::include_graphics("figs/Sick_Sicker_figure.png")
```
