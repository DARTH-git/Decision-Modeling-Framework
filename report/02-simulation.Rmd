...
Using the code below, we can graphically show the model dynamics by plotting the cohort trace. Figure \@ref(fig:Sick_Sicker_Trace) shows the distribution of the cohort among the different health states at each time point. 

```{r Sick_Sicker_Trace, echo = FALSE, fig.cap = 'Cohort trace of the Sick-Sicker cohort model', message = FALSE, warning = FALSE, fig.pos = "H"} 
