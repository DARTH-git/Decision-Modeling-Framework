...
|:-----------------------------------|:-----------:|:-------------:|
| Time horizon ($n_t$)               | `n_t`       | `r l.params.all$n_t` years |
| Names of health states ($n$)       | `v_n`       | H, S1, S2, D  |
| Annual discount rate (costs/QALYs) | `d_c`/`d_e` |  3%           |
| Annual transition probabilities    |             |               |
| - Disease onset (H to S1)          | `p_HS1`     |  `r l.params.all$p_HS1`         |
| - Recovery (S1 to H)               | `p_S1H`     |  `r l.params.all$p_S1H`          |
| - Disease progression (S1 to S2)  in the time-homogenous model   | `p_S1S2`    |  `r l.params.all$p_S1S2`        |
| Annual mortality                   |             |               |
| - All-cause mortality (H to D)     | `p_HD`      |  age-specific |
| - Hazard rate ratio of death in S1 vs H | `hr_S1`     |  `r l.params.all$hr_S1`            |
| - Hazard rate ratio of death in S2 vs H | `hr_S2`     |  `r l.params.all$hr_S1`           |
| Annual costs                       |             |               |
