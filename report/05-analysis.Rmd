...
![The cost-effectiveness plane graph showing the results of the probabilistic sensitivity analysis for the Sick-Sicker case-study. \label{fig:05b_CEAplane}](../figs/05b_cea_plane_scatter.png)
...
![Cost-effectiveness frontier\label{fig:05b_cea-frontier-psa}](figs/05b_cea_frontier_psa.png)

![Cost-effectiveness acceptability curves (CEACs) and frontier (CEAF)\label{fig:05b_ceac_ceaf}](figs/05b_ceac_ceaf.png)

![Expected Loss Curves \label{fig:05b_elc}](figs/05b_elc.png)

![One-way sensitivity analysis (OWSA)  \label{fig:05b_owsa_lrm_nmb}](figs/05b_owsa_lrm_nmb.png)

![Optimal strategy with OWSA \label{fig:05b_optimal_owsa_lrm_nmb}](figs/05b_optimal_owsa_lrm_nmb.png)

![Tornado plot \label{fig:05b_tornado_lrm_Treatment_nmb}](../figs/05b_tornado_lrm_Treatment_nmb.png)


![Two-way sensitivity analysis (TWSA) \label{fig:05b_twsa_lrm_uS1_uTrt_nmb}](figs/05b_twsa_lrm_uS1_uTrt_nmb.png)
...
```{r, eval = FALSE, echo = TRUE}
evpi <- calc_evpi(wtp = v_wtp, psa = l.psa)
```
