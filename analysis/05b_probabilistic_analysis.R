...
#   05a_deterministic_analysis_functions.R                                     #
#   05b_probabilistic_analysis_functions.R                                     #
#                                                                              # 
# Authors:                                                                     #
...
source("R/05a_deterministic_analysis_functions.R")
source("R/05b_probabilistic_analysis_functions.R")
